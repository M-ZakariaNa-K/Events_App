...
PublicEventTicketsModel publicEventTicketsModelFromJson(String str) =>
    PublicEventTicketsModel.fromJson(json.decode(str));

String publicEventTicketsModelToJson(PublicEventTicketsModel data) =>
...
class PublicEventTicketsModel {
  ...
  factory PublicEventTicketsModel.fromJson(Map<String, dynamic> json) =>
      PublicEventTicketsModel(
        code: json["code"],
        message: json["message"],
        data: List<PublicEventTicketsDataModel>.from(
            json["data"].map((x) => PublicEventTicketsDataModel.fromJson(x))),
      );
...
class PublicEventTicketsDataModel {
  ...
  factory PublicEventTicketsDataModel.fromJson(Map<String, dynamic> json) =>
      PublicEventTicketsDataModel(
