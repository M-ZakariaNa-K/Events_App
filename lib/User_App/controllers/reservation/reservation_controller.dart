...
import 'package:events_app/User_App/model/reservations/public_event_tickets.dart';
...
class ReservationController extends GetxController {
  ...
  Future<void> getReservationDeatilsItems({
    ...
    try {
      ...
      final reservationListModel = PublicEventTicketsModel.fromJson(data1);
      publicEventTicketsList.assignAll(reservationListModel.data);
